...
using CalendarApp.Controllers.ActionFilters;
    ...
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> Create(EventViewModel vm, IFormCollection form)
        {
            try
            {
                ...
                TempData["Alert"] = "You created a new event for: " + form["Event.Name"];
        ...
        public async Task<IActionResult> Edit(int id, IFormCollection form)
        {
            try
            {
                ...
                TempData["Alert"] = "You modified an event for: " + form["Event.Name"];

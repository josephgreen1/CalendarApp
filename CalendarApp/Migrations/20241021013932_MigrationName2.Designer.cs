...
namespace CalendarApp.Migrations
{
    ...
    [Migration("20241021013932_MigrationName2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalendarApp.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CalendarApp.Models.Event", b =>
                {
                    ...
                    b.HasOne("CalendarApp.Models.ApplicationUser", "User")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CalendarApp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
